...
const PostList = () => {
  ...
  const fetchReplies = (postId) => {
    axios
      ...
      .then((response) => {
        setPosts(
          posts.map((post) =>
            post.post_id === postId ? { ...post, replies: response.data } : post
          )
        );
      })
      .catch((error) => {
  ...
  return (
    <><h2>Forum</h2><div className="post-list-container">
                          ...
                          <Card.Body>
                              ...
                              <div className="reply-main-container">
                                  <Card.Subtitle
                                      ...
                                      onClick={() => fetchReplies(post.post_id)}
                                  >
                                      View Reply
                                  </Card.Subtitle>
                              ...
                              <Form
                                  onSubmit={(event) => handleReplySubmit(event, post.post_id)}
                              >
                                  <Form.Group controlId={`replyContent-${post.post_id}`}>
                                      <Form.Control type="text" placeholder="Enter your reply" />
                                  </Form.Group>
